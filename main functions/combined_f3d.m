function []=combined_f3d(params_dataset)
disp('Training...');
temp_count=0;
Y_tr1=[];
count_action=0;
nSteps=10;
load('Y:\projects\iisc\IISC internship\Score fusion\data\Florence3D\skeletal_data.mat');
...
for a=1:9
    ...
    for s=1:2:9
        for e=1:215
            if skeletal_data{e,1}.subject==s && skeletal_data{e,1}.action==a
                
                B=skeletal_data{e,1}.original_skeletal_data;
...
fprintf('Recognition accuracy for Florence 3D =%f\n',recog_nn);
